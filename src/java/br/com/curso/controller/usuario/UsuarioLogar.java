...
public class UsuarioLogar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (oUsuario != null) {
                //cia a sessao contexto do sistem\a
                ...
                //usuario recusado
                System.out.println("Uusario ou senha invalida, verificar dados");
                usuarioLogado = "";
            }
            ...
            System.out.println("Problemas ao logar Usuário! Erro:"+ex.getLocalizedMessage());
            ex.printStackTrace();
        }
    }
