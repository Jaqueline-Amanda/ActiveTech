                        ...
                        <c:forEach var="atividade" items="${atividades}">
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <button class="btn btn-group-lg
                                                <c:out value="${atividade.status == 'N' ? 'btn-danger': 'btn-success'}"/>">
                                    </button>
...
<script>
   $(document).ready(function(){
        ...
        var mensagemSucesso = (acao === 'inativar') ? 'Atividade inativada com sucesso!' : 'Atividade ativada com sucesso!';
            var mensagemErro = (acao === 'inativar') ? 'Não foi possível inativar a Atividade!' : 'Não foi possível ativar a Atividade!';
        console.log(codigo);
        Swal.fire({
